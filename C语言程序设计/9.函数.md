...
```
注意事项：![image.png](https://cdn.nlark.com/yuque/0/2023/png/38980263/1695968630816-5b555b63-e3ec-4ff2-ab36-4b510ee92b09.png#averageHue=%232e2b21&clientId=u9853408e-ce93-4&from=paste&height=196&id=uf4311a87&originHeight=294&originWidth=932&originalType=binary&ratio=1.5&rotation=0&showTitle=false&size=88034&status=done&style=none&taskId=u5dd14659-afeb-4414-843e-22d4504ca8b&title=&width=621.3333333333334)

因为如果每次返回的时间间隔不超过一秒，就会返回一个相同的时间戳，从而返回一个相同的种子，从而导致每次生成的数都相同。

因此每次调用**time**函数(或者**srand**函数)之间放在整个工程就行了。
