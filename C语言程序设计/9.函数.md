...
<img src="C:\Users\31866\AppData\Roaming\Typora\typora-user-images\image-20231107150049529.png" alt="image-20231107150049529" style="zoom:80%;" />
...
<img src="C:\Users\31866\AppData\Roaming\Typora\typora-user-images\image-20231111165202078.png" alt="image-20231111165202078" style="zoom:67%;" />
...
`strcspn()`函数的功能是返回字符串`str1`中从开头开始的连续字符，直到第一个出现在`str2`中的字符之前的字符数。换句话说，它返回的是`str1`中不包含`str2`中任何字符的最长前缀长度。
