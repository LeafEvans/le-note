...
![image-20231031153516863](C:\Users\31866\AppData\Roaming\Typora\typora-user-images\image-20231031153516863.png)

![image-20231031153533825](C:\Users\31866\AppData\Roaming\Typora\typora-user-images\image-20231031153533825.png)
...
int main(void)
{
    ...
    for (vp = &values[0]; vp < &values[N_VALUES];) // 两个指针进行比较，这就是关系运算
    {
