...
<img src="../images/image-202508201735.webp" style="zoom: 45%;" />
...
<img src="../images/image-202508241207.webp" style="zoom: 33%;" />
...
<img src="../images/image-202508241205.webp" style="zoom: 43%;" />
...
<img src="../images/image-202508241312.webp" style="zoom: 33%;" />
...
<img src="../images/image-202508241315.webp" style="zoom:33%;" />
...
<img src="../images/image-202508241337.webp" style="zoom: 43%;" />
...
<img src="../images/image-202508241355.webp" style="zoom:50%;" />

### 进程的组织——索引方式

<img src="../images/image-202508241359.webp" style="zoom:43%;" />

### 进程的组织

![](../images/image-202508241405.svg)
...
<img src="../images/image-202508241444.webp" style="zoom: 43%;" />

**举例**：假设 PCB 中的变量 `state` 表示进程所处的状态，1 表示就绪态、2 表示阻塞态……

<img src="../images/image-202508241449.webp" style="zoom:43%;" />
...
<img src="../images/image-202508241450.webp" style="zoom:43%;" />
...
<img src="../images/image-202508241452.webp" style="zoom:43%;" />

之后 CPU 会处理之前没有处理的外部中断信号，转向执行中断处理程序。

<img src="../images/image-202508241455.webp" style="zoom:43%;" />
...
<img src="../images/image-202508241457.webp" style="zoom: 43%;" />

**进程的撤销**：

<img src="../images/image-202508241459.webp" style="zoom:43%;" />

**进程的阻塞和唤醒**：

<img src="../images/image-202508241503.webp" style="zoom:43%;" />
...
<img src="../images/image-202508241507.webp" style="zoom:35%;" />

<img src="../images/image-202508241508.webp" style="zoom:35%;" />
...
<img src="../images/image-202508241512.webp" style="zoom:35%;" />

当原本的进程再次投入运行时，可以<span style="color:red">通过 PCB 恢复它的运行环境</span>。

---

<img src="../images/image-202508241518.webp" style="zoom:43%;" />
...
<img src="../images/image-202508241538.webp" style="zoom:50%;" />

进程 P 调用发送原语 `send(A, msg)`，将消息 `msg` 发送到信箱 A 中。进程 P 的地址空间不再包含该消息，而信箱 A 中现在包含了消息 `msg`。

<img src="../images/image-202508241539.webp" style="zoom:50%;" />

进程 Q 调用接收原语 `receive(A, &msg)`，从信箱 A 中接收消息 `msg`。此时，进程 Q 的地址空间包含消息 `msg`，而信箱 A 中的消息被取出，信箱 A 为空。

<img src="../images/image-202508241540.webp" style="zoom:50%;" />

可以多个进程往同一个信箱 `send` 消息，也可以多个进程从同一个信箱中 `receive` 消息。

### 管道通信

<img src="../images/image-202508241542.webp" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250526_082219.png" style="zoom:33%;" />
...
- $7$ 时刻（<span style="color:red">$P_2(2)$</span> $\rightarrow$ $P_4(6)$ $\rightarrow$ $P_1(1)$）：虽然 $P_3$ 的<span style="color:red">时间片没用完</span>，但是由于 $P_3$ 只需要运行一个单位的时间，运行完了会<span style="color:red">主动放弃处理机</span>，因此也会发生调度。队头进程 $P_2$ 上处理机
  ...
  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250516223631155.png" alt="image-20250516223631155" style="zoom:33%;" />
...
1. **<span style="color:#F564A9">推迁移（Push）策略</span>**：一个特定的系统程序周期性检查每个处理器的负载，如果负载不平衡，就从忙碌 CPU 的就绪队列中“推”一些就绪进程到空闲 CPU 的就绪队列
   ...
   <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250519_123440.png" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250527_104758.png" style="zoom:42%;" />

## 进程互斥的软件实现方法

**知识总览**：

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202505251544.png" style="zoom: 20%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250525195733351.png" alt="image-20250525195733351" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250525181438116.png" alt="image-20250525181438116" style="zoom:50%;" />

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250525193909558.png" alt="image-20250525193909558" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250525193801226.png" alt="image-20250525193801226" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250525_201703.png" style="zoom:40%;" />

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250525_201921.png" style="zoom:33%;" />
...
![image-20250525204210825](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250525204210825.png)

## 进程互斥的硬件实现方法

**知识总览**：

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202505252255.png" style="zoom:15%;" />

### 中断屏蔽方法

利用“开/关中断指令”实现。（与原语实现思想相同，即在某进程开始访问临界区到结束访问为止都不允许被中断，也就不能发生进程切换，因此也不可能发生两个同时访问临界区的情况）

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250525225913052.png" alt="image-20250525225913052" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250526000737109.png" alt="image-20250526000737109" style="zoom: 33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250526084909453.png" alt="image-20250526084909453" style="zoom:50%;" />

## 信号量机制

**知识总览**：

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202505260918.png" style="zoom:25%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250526100257331.png" alt="image-20250526100257331" style="zoom: 33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250526_104301.png" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506021854.png" style="zoom:50%;" />
...
>
> <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250602190919351.png" alt="image-20250602190919351" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250602211341380.png" alt="image-20250602211341380" style="zoom:33%;" />

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250602_211212.png" style="zoom:33%;" />

---

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250602_212025.png" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250603_160604.png" style="zoom:33%;" />

只有缓冲区不空时，消费者才能从中取出产品，否则必须等待。

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250603_161028.png" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250603161523261.png" alt="image-20250603161523261" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/屏幕截图_20250607_144250.png" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250608151812039.png" alt="image-20250608151812039" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250608205216449.png" alt="image-20250608205216449" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250608211512103.png" alt="image-20250608211512103" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250608224717944.png" alt="image-20250608224717944" style="zoom: 33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250609200048152.png" alt="image-20250609200048152" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250610202645136.png" alt="image-20250610202645136" style="zoom:50%;" />
...
![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202505121341.png)
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250612141757919.png" alt="image-20250612141757919" style="zoom:50%;" />
