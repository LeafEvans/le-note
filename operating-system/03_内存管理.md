...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202508030218.png" style="zoom:80%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202606201749.svg"  />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250620180617817.png" alt="image-20250620180617817" style="zoom:40%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250620181234860.png" alt="image-20250620181234860" style="zoom:80%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506202001.png" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506201917.png" style="zoom:33%;" />

---

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506201931.png" style="zoom:70%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506202322.png" style="zoom: 50%;" />

在传统存储管理方式的基础上引入了交换技术、覆盖技术，使得内存利用率有所提升，并且能从逻辑上扩充内存容量。

![image-202506202315](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506202315.svg)

### 传统存储管理方式的特征、缺点

![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506202328.svg)
...
![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202507081415.svg)
...
![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506202359.svg)

![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506210006.svg)
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506210016.png" style="zoom: 80%;" />
...
![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506210202.svg)
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621120521338.png" alt="image-20250621120521338" style="zoom:40%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621121044127.png" alt="image-20250621121044127" style="zoom:33%;" />

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621121104192.png" alt="image-20250621121104192" style="zoom: 33%;" />

如果内存中<span style="color:#E82561">有空闲块</span>，则为进程<span style="color:#E82561">分配一个空闲块</span>，将所缺页面装入该块，并修改页表中相应的页表项。

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621121648216.png" alt="image-20250621121648216" style="zoom: 33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621121748596.png" alt="image-20250621121748596" style="zoom: 33%;" />

<span style="color:#EB8317">**缺页中断**</span>是因为当前执行的指令想要访问的目标页面未调入内存而产生的，因此<span style="color:#EB8317">**属于内中断**</span>。

![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621240.svg)
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621132017726.png" alt="image-20250621132017726" style="zoom: 50%;" />

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621135053446.png" alt="image-20250621135053446" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506211359.png" style="zoom:50%;" />

## 页面置换算法

**知识总览**：

![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621530.svg)
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621153921180.png" alt="image-20250621153921180" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621155622739.png" alt="image-20250621155622739" style="zoom:50%;" />

若分配了<span style="color:#C70039">四个</span>内存块：

<img src="/home/leafevans/.config/Typora/typora-user-images/image-20250621155914021.png" alt="image-20250621155914021" style="zoom:40%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621175020463.png" alt="image-20250621175020463" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621175838555.png" alt="image-20250621175838555" style="zoom:50%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621181123364.png" alt="image-20250621181123364" style="zoom: 33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621181516726.png" alt="image-20250621181516726" style="zoom:33%;" />

之后要进来 6 号页，在第一轮扫描中发现所有的页面为 1，因此均置为 0；在第二轮扫描中，将 1 号页换为 6 号页，将其访问位置为 1，扫描指针指向 3 号位。

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621181750389.png" alt="image-20250621181750389" style="zoom:33%;" />

之后访问了 3 号页和 4 号页，其访问位被置为 1：

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621182613430.png" alt="image-20250621182613430" style="zoom:33%;" />

为了插入 7 号页，扫描指针从当前位置依次扫描，并将 1 置为 0；2 号页符合，将 2 号页换为 7 号页，并将其访问位置为 1，指针再指向下一个页面的位置：

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621182927863.png" alt="image-20250621182927863" style="zoom:33%;" />
...
- **一轮扫描**的情况下，有：
  ...
  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621192242235.png" alt="image-20250621192242235" style="zoom:50%;" />

  在第一轮中便找到了符合的页面：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621192427871.png" alt="image-20250621192427871" style="zoom:50%;" />

- **二轮扫描**的情况下，有：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621192948806.png" alt="image-20250621192948806" style="zoom:50%;" />

  第一轮的扫描没有找到符合 `(0, 0)` 的，也没有找到标志位；在第二轮扫描中，访问位会置为 0，最终找到 `(0, 1)` 的页面（一开始就是 `(0, 1)`，而不是访问后变成 `(0, 1)`）：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621193249666.png" alt="image-20250621193249666" style="zoom:50%;" />

- **三轮扫描**的情况下，有：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621193511847.png" alt="image-20250621193511847" style="zoom: 50%;" />

  在第一轮扫描中，没有发现 `(0, 0)` 的页面；在第二轮扫描中，将访问位置为 0，但是依旧没有找到 `(0, 1)` 的帧：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621193643547.png" alt="image-20250621193643547" style="zoom:50%;" />

  最终在第三轮中找到 `(0, 0)` 这个界面：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621195459020.png" alt="image-20250621195459020" style="zoom:50%;" />

- **四轮扫描**的情况下，有：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506211957.png" style="zoom:50%;" />

  在前两轮扫描后：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621195725768.png" alt="image-20250621195725768" style="zoom:50%;" />

  第三轮扫描过程中，没有找到 `(0, 0)` 标志位的；最后在第四轮中选取了 `(0, 1)` 标志位的页面：

  <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621195944326.png" alt="image-20250621195944326" style="zoom:50%;" />
...
![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250622057.svg)
...
1. <span style="color:#7886C7">**系统拥有足够的对换区空间**</span>：页面的调入、调出都是在内存与**对换区之间进行**，这样可以保证页面的**调入、调出速度很快**；在进程运行前需将进程相关的数据**从文件区复制到对换区**
   ...
   <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621220611935.png" alt="image-20250621220611935" style="zoom:33%;" />
...
2. **<span style="color:#497D74">系统缺少足够的对换区空间</span>**：凡是**不会被修改**的数据都直接从**文件区调入**，由于这些页面不会被修改，因此换出时**不必写回磁盘**，下次需要时再从文件区调入即可；对于可能被修改的部分，换出时需写回磁盘对换区，下次需要时再从对换区调入
   ...
   <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621221017911.png" alt="image-20250621221017911" style="zoom:33%;" />
...
3. <span style="color:#DE3163; font-weight:bold">UNIX 方式</span>：运行之前进程有关的数据**全部**放在**文件区**，故未使用过的页面，都**可从文件区调入**；若被使用过的页面需要换出，则写回对换区，下次需要时从对换区调入
   ...
   <img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621221226045.png" alt="image-20250621221226045" style="zoom:33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250621222659195.png" alt="image-20250621222659195" style="zoom: 33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506212236.png" style="zoom:50%;" />

## 内存映射文件

**知识总览**：

![](https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506220024.svg)

### 传统的文件访问方式

<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250622002948604.png" alt="image-20250622002948604" style="zoom: 33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-20250622003550935.png" alt="image-20250622003550935" style="zoom: 33%;" />
...
<img src="https://leafalice-image.oss-cn-hangzhou.aliyuncs.com/img/image-202506220044.png" style="zoom:50%;" />
