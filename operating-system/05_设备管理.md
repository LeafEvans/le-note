...
<img src="../images/operating-system/image_20250803_033100.svg"  />
...
<img src="../images/operating-system/image_20250803_032500.webp" style="zoom: 45%;" />
...
<img src="../images/operating-system/image_20250803_033600.svg" style="zoom:80%;" />
...
<img src="../images/operating-system/image_20250803_040300.svg" style="zoom:80%;" />
...
<img src="../images/operating-system/image_20250803_035900.webp" style="zoom:80%;" />

## I/O 控制器

**知识总览**：

<img src="../images/operating-system/image_20250803_050100.svg" style="zoom:80%;" />

I/O 设备由机械部件和电子部件组成。

### I/O 设备的机械部件

<img src="../images/operating-system/image_20250803_050800.webp" style="zoom: 5%;" />
...
<img src="../images/operating-system/image_20250803_053600.svg" style="zoom:80%;" />
...
<img src="../images/operating-system/image_20250804_032200.svg" style="zoom:75%;" />
...
<img src="../images/operating-system/image_20250803_074700.svg" style="zoom:80%;" />
...
<img src="../images/operating-system/image_20250815_003500.webp" style="zoom:80%;" />

## I/O 控制方式

**知识总览**：

<img src="../images/operating-system/image_20250804_024500.svg"  />
...
<img src="../images/operating-system/image_20250804_033400.svg" style="zoom:80%;" />
...
<img src="../images/operating-system/image_20250807_023000.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250807_023100.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250808_111600.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250808_111800.svg" style="zoom:80%;" />
...
<img src="../images/operating-system/image_20250808_112100.svg" style="zoom:80%;" />
...
<img src="../images/operating-system/image_20250808_112300.svg" style="zoom:67%;" />
...
<img src="../images/operating-system/image_20250814_224600.svg" style="zoom:67%;" />

每一层会利用其下层提供的服务，实现某些功能，并屏蔽实现的具体细节，向高层提供服务。（<span style="color:#E43636">封装思想</span>）

### 用户层软件

<img src="../images/operating-system/image_20250815_013000.svg" style="zoom:67%;" />
...
<img src="../images/operating-system/image_20250815_023800.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250815_023600.svg" style="zoom:80%;" />

<img src="../images/operating-system/image_20250815_023700.svg" style="zoom:80%;" />
...
<img src="../images/operating-system/image_20250815_031000.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250819_104700.svg" style="zoom:150%;" />

### 输入/输出应用程序接口

<img src="../images/operating-system/image_20250819_111200.svg"  />

显然，用户层的应用程序无法用一个<span style="color:#239BA7"><u>统一的系统调用</u></span>接口来完成所有类型设备的 I/O。

<img src="../images/operating-system/image_20250819_111700.svg"  />
...
- 网络设备接口，又称**<span style="color:#D92C54">网络套接字（`socket`）接口</span>**：
  ...
  <img src="../images/operating-system/image_20250819_125800.svg"/>
...
<img src="../images/operating-system/image_20250819_140500.svg"/>

若各公司开发的设备驱动程序接口不统一，则操作系统很难调用设备驱动程序。

<img src="../images/operating-system/image_20250819_191300.svg"/>
...
![](../images/operating-system/image_20250819_191400.svg)
...
<img src="../images/operating-system/image_20250819_203800.webp" style="zoom: 50%;" />

### 脱机技术的定义

<img src="../images/operating-system/image_20250819_191500.svg" style="zoom:150%;" />
...
<img src="../images/operating-system/image_20250819_191600.svg"/>
...
![](../images/operating-system/image_20250820_090500.svg)
...
![](../images/operating-system/image_20250820_132400.svg)
...
![](../images/operating-system/image_20250820_134300.svg)

SPOOLing 技术可以把一台物理设备<span style="color:#EA047E">虚拟</span>成逻辑上的多台设备，<span style="color:#EA047E">可将独占式设备改造成共享设备</span>。

---

<img src="../images/operating-system/image_20250820_135000.webp" style="zoom:150%;" />

## 设备的分配与回收

**知识总览**：

![](../images/operating-system/image_20250820_140200.svg)

### 设备分配时应考虑的因素

![](../images/operating-system/image_20250820_141200.svg)
...
![](../images/operating-system/image_20250820_151800.svg)
...
<img src="../images/operating-system/image_20250820_151900.svg" style="zoom:80%;" />
...
![](../images/operating-system/image_20250820_180100.webp)

## 缓冲区管理

**知识总览**：

<img src="../images/operating-system/image_20250821_090700.svg"  />
...
![](../images/operating-system/image_20250821_093000.svg)

![](../images/operating-system/image_20250821_093200.svg)

CPU 可以将要输出的数据<u>快速地</u>放入缓冲区，之后就可以做其他事；慢速的 I/O 设备可以<u>慢慢</u>从缓冲区取走数据；数据输入时类似。

![](../images/operating-system/image_20250821_093300.svg)
...
![](../images/operating-system/image_20250821_102900.svg)
...
- **<span style="color:#001BB7">假设 T > C</span>**，因此 CPU 处理完数据后暂时不能将下一块数据传送到工作区，必须等待缓冲区中充满数据。
  ...
  ![](../images/operating-system/image_20250821_111700.svg)

  处理一块数据的平均用时为 T + M。

- **<span style="color:#001BB7">假设 T < C</span>**，因此缓冲区中充满数据后暂时不能继续充入下一块数据，必须等待 CPU 处理结束后将数据从缓冲区传送到工作区。

  ![](../images/operating-system/image_20250821_111800.svg)
...
![](../images/operating-system/image_20250821_122300.svg)

若初始状态为<span style="color:#1679AB">工作区空，其中一个缓冲区满，另一个缓冲区空</span>。

- <span style="color:#266352">**假设 T > C + M**</span>：

  ![](../images/operating-system/image_20250821_122400.svg)
...
- <span style="color:#266352">**假设 T < C + M**</span>：
  ...
  ![](../images/operating-system/image_20250821_133500.svg)
...
<img src="../images/operating-system/image_20250821_135200.svg" style="zoom:67%;" />

显然，若两个相互通信的机器只设置单缓冲区，在任一时刻只能实现数据的<span style="color:#FF76CE; font-weight:bold">单向传输</span>。

<img src="../images/operating-system/image_20250821_135700.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250821_141400.svg"  />
...
<img src="../images/operating-system/image_20250821_142500.svg" style="zoom: 80%;" />

<img src="../images/operating-system/image_20250821_143200.svg" style="zoom: 50%;" />
...
<img src="../images/operating-system/image_20250821_145600.webp" style="zoom:80%;" />

## 磁盘的结构

**知识总览**：

![](../images/operating-system/image_20250822_021800.svg)

### 磁盘、磁道、扇区

磁盘的表面由一些磁性物质组成，可以用这些磁性物质来记录二进制数据。

<img src="../images/operating-system/image_20250822_022500.webp" style="zoom: 33%;" />
...
<img src="../images/operating-system/image_20250822_123800.svg" style="zoom:125%;" />

### 如何在磁盘中读/写数据

需要把“磁头”移动到想要读/写的扇区所在的磁道。磁盘会转起来，让目标扇区从磁头下面划过，才能完成对扇区的读/写操作。

<img src="../images/operating-system/image_20250822_123900.svg" style="zoom:125%;" />

### 盘面、盘柱

<img src="../images/operating-system/image_20250822_133800.svg" style="zoom:67%;" />
...
<img src="../images/operating-system/image_20250822_151900.svg" style="zoom:67%;" />

磁头不可移动的称为<span style="color:#D32626">固定磁头磁盘</span>。这种磁盘中每个磁道有一个磁头。

<img src="../images/operating-system/image_20250822_153000.svg" style="zoom:67%;" />

根据盘片是否可以更换分为<span style="color:#F05D23">可换盘磁盘</span>、<span style="color:#F05D23">固定盘磁盘</span>。

---

![](../images/operating-system/image_20250822_155000.png)

## 磁盘调度算法

**知识总览**：

![](../images/operating-system/image_20250822_163100.svg)

### 一次磁盘读/写操作需要的时间

![](../images/operating-system/image_20250822_163800.svg)
...
<img src="../images/operating-system/image_20250822_180700.svg" style="zoom:67%;" />
...
<img src="../images/operating-system/image_20250822_182100.svg" style="zoom: 67%;" />
...
![](../images/operating-system/image_20250822_183500.svg)
...
![](../images/operating-system/image_20250822_192800.svg)
...
![](../images/operating-system/image_20250822_193700.svg)
...
![](../images/operating-system/image_20250822_195000.svg)
...
![](../images/operating-system/image_20250822_200100.webp)

## 减少延迟时间的方法

<img src="../images/operating-system/image_20250823_012900.svg" style="zoom:150%;" />

<img src="../images/operating-system/image_20250823_015000.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250823_022700.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250823_024300.svg" style="zoom:67%;" />
...
<img src="../images/operating-system/image_20250823_030300.svg" style="zoom:67%;" />
...
<img src="../images/operating-system/image_20250823_074700.svg" style="zoom:67%;" />
...
<img src="../images/operating-system/image_20250823_075900.svg" style="zoom:67%;" />
...
![](../images/operating-system/image_20250823_080500.png)

## 磁盘的管理

**知识总览**：

<img src="../images/operating-system/image_20250823_083200.svg"  />

### 磁盘初始化

<img src="../images/operating-system/image_20250823_083800.svg" style="zoom: 50%;" />
...
1. 进行<span style="color:#EF4B4B">**低级格式化（物理格式化）**</span>，将磁盘的各个磁道<span style="color:#EF4B4B">**划分为扇区（磁盘的最小存储单元）**</span>。一个扇区通常可分为头、数据区域（如 512B 大小）、尾三个部分组成。管理扇区所需要的各种数据结构一般存放在头、尾两个部分，包括扇区校验码（如奇偶校验、CRC 循环冗余校验码等，校验码用于校验扇区中的数据是否发生错误）。
   ...
   <img src="../images/operating-system/image_20250823_084000.svg" style="zoom:50%;" />

2. 将磁盘分区，每个分区由<span style="color:#02A8A8">**若干柱面**</span>组成（即分为我们熟悉的 C 盘、D 盘、E 盘）。

   <img src="../images/operating-system/image_20250823_084500.svg" style="zoom: 50%;" />
...
<img src="../images/operating-system/image_20250823_084600.svg" style="zoom: 67%;" />
...
<img src="../images/operating-system/image_20250823_093500.svg" style="zoom:50%;" />
...
<img src="../images/operating-system/image_20250823_102400.svg" style="zoom: 50%;" />

对于<span style="color:#FE6845">**复杂的磁盘**</span>，磁盘控制器（磁盘设备内部的一个硬件部件）会维护一个坏块链表。

在磁盘出厂前进行低级格式化（物理格式化）时就将坏块链进行初始化。

会保留一些<span style="color:#FF2E63; font-weight:bold">备用扇区</span>，用来替换坏块。这种方案称为<span style="color:#387ADF">**_扇区备用_**</span>。且这种处理方式中，<span style="color:#387ADF">**坏块对操作系统透明**</span>。

<img src="../images/operating-system/image_20250823_103000.svg" style="zoom:50%;" />

---

<img src="../images/operating-system/image_20250823_103300.png" style="zoom:80%;" />

## 固态硬盘 SSD

**知识总览**：

![](../images/operating-system/image_20250823_115800.webp)

### 机械硬盘 vs. 固态硬盘

<img src="../images/operating-system/image_20250823_120800.webp" style="zoom: 25%;" />

### 固态硬盘的结构

![](../images/operating-system/image_20250823_123400.svg)
