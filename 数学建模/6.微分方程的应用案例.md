...
plt.ylabel("Proportion")
plt.axis([0, t_end, -0.1, 1.1])
plt.plot(t, ySEIRD[:, 0], "--", label="s(t)-SEIR")
plt.plot(t, ySEIRD[:, 1], "-", label="e(t)-SEIR")
plt.plot(t, ySEIRD[:, 2], "-", label="i(t)-SEIR")
plt.plot(t, ySEIRD[:, 3], ":", label="r(t)-SEIR")
plt.plot(t, ySEIRD[:, 4], ":", label="d(t)-SEIR")
plt.legend()
plt.show()
```
