...
<img src="../../images/cpp-programming/image_20240411_174900.webp" style="zoom:67%;" />

也即就是它找不到 `add` 函数。

查看 `example.o` 和 `main.o` 的符号表：

<img src="../../images/cpp-programming/image_20240411_175000.png" style="zoom:67%;" />

上图中的 `add` 是 `gcc` 对函数 `add` 编译完后生成的符号。

<img src="../../images/cpp-programming/image_20240411_175100.webp" style="zoom:67%;" />
...
<img src="../../images/cpp-programming/image_20240411_191900.svg" style="zoom:80%;" />
...
<img src="../../images/cpp-programming/image_20240411_213100.png" style="zoom:80%;" />

在 C++ 中，`NULL` 为：

<img src="../../images/cpp-programming/image_20240411_213200.png" style="zoom: 80%;" />
