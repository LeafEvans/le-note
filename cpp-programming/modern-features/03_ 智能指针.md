...
<img src="../../images/cpp-programming/image_20250205_121200.png" style="zoom:50%;" />
...
<img src="../../images/cpp-programming/image_20250205_121500.png" style="zoom:50%;" />
...
1. **`unique` 函数**：判断 `shared_ptr` 是对象是否独占内存；若独占，返回 `true`；反之返回 `false`。
   ...
   <img src="../../images/cpp-programming/image_20250205_123100.png" style="zoom:50%;" />
...
2. **`reset` 函数**：
   ...
   <img src="../../images/cpp-programming/image_20250206_210800.png" style="zoom:50%;" />

3. **`get` 函数**：获得封装前的裸指针。（强烈不推荐使用）
...
4. **`swap` 函数**：交换两个智能指针所指向的内存。
   ...
   <img src="../../images/cpp-programming/image_20250206_212100.png" style="zoom:50%;" />
...
<img src="../../images/cpp-programming/image_20250206_213200.png" style="zoom:50%;" />
...
<img src="../../images/cpp-programming/image_20250206_213700.png" style="zoom:50%;" />
