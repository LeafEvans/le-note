...
<img src="../images/computer-network/image_20251224_000400.webp" style="zoom:60%;" />
...
<img src="../images/computer-network/image_20251224_001700.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_002600.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251224_004900.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_005300.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_010300.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251224_013700.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251224_020600.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_010500.webp" style="zoom:50%;" />

### IP 数据报的“分片”问题

<img src="../images/computer-network/image_20251224_011100.webp" style="zoom:50%;" />

**重要概念**：一个链路层数据帧能承载的最大数据量称为<u>最大传送单元（MTU）</u>。如以太网的 MTU = 1500B。

若一个 IP 数据报的总长度超出了下一段链路的 MTU，就需要分片。

<img src="../images/computer-network/image_20251224_011800.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251224_011900.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_020100.webp" style="zoom:50%;" />

### IP 数据报的生存时间“TTL”（不可达示例）

<img src="../images/computer-network/image_20251224_015800.webp" style="zoom:50%;" />

---

**知识回顾**：

<img src="../images/computer-network/image_20251224_020900.jpg" style="zoom:50%;" />

## IP 地址（最初的分类方案）

### IP 数据报（IP 分组）的格式

<img src="../images/computer-network/image_20251224_021600.jpg" style="zoom:50%;" />

### 最初的 IP 地址分类方案

<img src="../images/computer-network/image_20251224_021700.jpg" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_022000.jpg" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_070900.jpg" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_074300.jpg" style="zoom:50%;" />

### 暂未使用子网划分技术

<img src="../images/computer-network/image_20251224_074800.jpg" style="zoom: 67%;" />

### 学校网络使用了子网划分技术（划分为两个子网道计算机）

<img src="../images/computer-network/image_20251224_080000.jpg" style="zoom: 67%;" />

### 学校网络使用了子网划分技术（划分为 4 个子网）

<img src="../images/computer-network/image_20251224_080500.jpg" style="zoom: 67%;" />

<img src="../images/computer-network/image_20251224_090700.jpg" style="zoom:50%;" />

<img src="../images/computer-network/image_20251224_090900.jpg" style="zoom:50%;" />

### 子网掩码的 CIDR 记法

<img src="../images/computer-network/image_20251224_091500.jpg" style="zoom: 67%;" />

## 无分类编制 CIDR

**知识总览**：

<img src="../images/computer-network/image_20251224_092100.jpg" style="zoom:50%;" />

**时代背景**：1993 年推出**无分类编址 CIDR**，当时互联网在民用领域大放异彩，由于每台主机都至少要消耗一个全球唯一的 IP 地址。**_<u>IP 地址资源告急。</u>_**

### 传统的 IP 地址划分方案有什么缺陷？

<img src="../images/computer-network/image_20251224_092300.jpg" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_092900.jpg" style="zoom:50%;" />

例如某单位有 2000 台主机想要联网，IP 地址管理机构可以给它分配一个 <span style="color:#E9A319">21bit 网络前缀</span>的 <span style="color:#5EABD6">CIDR 地址块</span>。

<img src="../images/computer-network/image_20251224_093500.jpg" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_094400.jpg" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_095600.jpg" style="zoom:50%;" />
...
2. 村里的年轻人诗歌剧想开网吧，于是向哈基米购买宽带服务。整个网吧有 12 台电脑，每台电脑需要分配一个 IP 地址，且所有电脑属于同一个子网。
   ...
   <img src="../images/computer-network/image_20251224_101100.png" style="zoom:50%;" />

3. 特别周家里很有钱，有 5 口人，人手一台电脑，每台电脑需要分配一个 IP 地址，所有电脑要组成一个子网。

   <img src="../images/computer-network/image_20251224_101700.png" style="zoom:50%;" />

4. 黄金船家里只有一台电脑，需要从哈基米电信的路由器拉一条<span style="color:#FF3F33">“路由器直连主机”的点对点链路</span>。

   <img src="../images/computer-network/image_20251224_102000.png" style="zoom:50%;" />

   <img src="../images/computer-network/image_20251224_102400.png" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_104400.png" style="zoom:50%;" />

---

<img src="../images/computer-network/image_20251224_105800.png" style="zoom:50%;" />

<img src="../images/computer-network/image_20251224_110100.png" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_110500.png" style="zoom:50%;" />

<img src="../images/computer-network/image_20251224_110400.png" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_110700.png" style="zoom:50%;" />

---

**知识回顾**：

<img src="../images/computer-network/image_20251224_111200.png" style="zoom:50%;" />

## 路由聚合

<img src="../images/computer-network/image_20251224_112000.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_121500.webp" style="zoom:50%;" />

**假设**：县里的电信路由器收到一个来自互联网的 IP 数据包，目的 IP 地址为 128.14.32.131 = 10000000.00001110.00100000.10000011。

<img src="../images/computer-network/image_20251224_121700.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_122200.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251224_122900.webp" style="zoom: 80%;" />

## 网络地址转换 NAT

**知识总览**：

<img src="../images/computer-network/image_20251225_104700.webp" style="zoom:50%;" />

### 传输层“端口号”的概念

<img src="../images/computer-network/image_20251225_105100.png" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251225_110500.png" style="zoom:50%;" />

### 如何缓解 IP 地址不够用的问题？

IP 地址 32bit，2^32^ ≈ 42 亿，如果每台主机都要消耗一个全球唯一的 IP 地址，显然不够用。

<img src="../images/computer-network/image_20251225_111800.png" style="zoom:50%;" />

<img src="../images/computer-network/image_20251225_112800.png" style="zoom:50%;" />

<img src="../images/computer-network/image_20251225_114200.png" style="zoom:50%;" />

## 地址解析协议 ARP

### 各种协议之间的服务关系

<img src="../images/computer-network/image_20251225_135000.jpg" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251225_135500.jpg" style="zoom:50%;" />

<img src="../images/computer-network/image_20251228_121100.webp" style="zoom:50%;" />

### 拓展：ARP 分组的格式

<img src="../images/computer-network/image_20251228_133800.webp" style="zoom:50%;" />

---

**知识回顾**：

<img src="../images/computer-network/image_20251225_135900.jpg" style="zoom:50%;" />

## 动态主机配置协议 DHCP

**知识总览**：

<img src="../images/computer-network/image_20251228_160300.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251228_161000.webp" style="zoom:50%;" />

![](../images/computer-network/image_20251228_161500.webp)

<img src="../images/computer-network/image_20251228_161900.png" style="zoom:50%;" />

<img src="../images/computer-network/image_20251228_162700.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251228_170600.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251228_170500.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251228_170400.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251228_171000.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251228_171200.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251228_171700.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251228_172100.webp" style="zoom:50%;" />

### ICMP 差错报告报文：终点不可达

<img src="../images/computer-network/image_20251228_172700.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20251228_172800.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251228_213200.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251228_231200.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251228_233300.webp" style="zoom:50%;" />
...
![](../images/computer-network/image_20251229_000600.webp)
...
<img src="../images/computer-network/image_20251229_003300.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251229_010100.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251229_010500.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251229_012100.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20251229_101100.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_005400.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_010600.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_015000.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260103_015300.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260103_015600.webp" style="zoom:50%;" />

### 回顾：IPv4 地址资源的分配

<img src="../images/computer-network/image_20260103_015800.webp" style="zoom:50%;" />

### IPv6 地址的分配

<img src="../images/computer-network/image_20260103_020000.webp" style="zoom:50%;" />

**优点**：IPv6 因为地址空间很大，所以可以划分为更多的层次。

<img src="../images/computer-network/image_20260103_020200.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_023000.webp" style="zoom:50%;" />

---

**知识总览**：

<img src="../images/computer-network/image_20250103_023200.webp" style="zoom:50%;" />

## 路由算法

**知识总览**：

<img src="../images/computer-network/image_20260103_135800.webp" style="zoom:50%;" />

### 路由算法与路由协议之间的关系

<img src="../images/computer-network/image_20260103_140000.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_140300.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_141800.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_150800.webp" style="zoom:50%;" />

---

<img src="../images/computer-network/image_20260103_151700.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260103_152000.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_155200.webp" style="zoom:50%;" />

---

**知识回顾**：

<img src="../images/computer-network/image_20260103_160900.webp" style="zoom:50%;" />

## 分层次的路由协议

### 思考：RIP、OSPF 能否用于全世界的路由器？

<img src="../images/computer-network/image_20260103_161700.png" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_163800.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_175000.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_175400.webp" style="zoom:50%;" />

### RIP 协议在协议栈中的位置

<span style="color:#D65D7A">RIP 属于应用层，它使用 UDP 传送数据（端口 = 520）。</span>

<img src="../images/computer-network/image_20260103_175600.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_181600.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_184000.webp" style="zoom:50%;" />
...
2. 对修改后的 RIP 报文中的每个项目，执行如下步骤：
   ...
   <img src="../images/computer-network/image_20260103_213500.svg" style="zoom: 67%;" />
...
<img src="../images/computer-network/image_20260103_214700.webp" style="zoom:50%;" />

### 初始：各路由器同时开机，构建初始路由表

<img src="../images/computer-network/image_20260103_224100.webp" style="zoom:50%;" />

路由器<span style="color:#6E026F">刚开始工作时，只知道自己到直接相连的几个网络的距离为 1</span>。

### 0 时刻：各路由器向邻居发送 RIP 报文（包含完整路由表）

<img src="../images/computer-network/image_20260103_224700.webp" style="zoom:50%;" />

每个路由器<span style="color:#E59934">仅和相邻路由器<u>周期性</u>（周期为 30 秒）地交换并更新路由信息</span>。

<img src="../images/computer-network/image_20260103_224300.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260103_225900.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_230800.webp" style="zoom:50%;" />

每个路由器<span style="color:#E59934">仅和相邻路由器<u>周期性</u>（周期为 30 秒）地交换并更新路由信息</span>。

<img src="../images/computer-network/image_20260103_231100.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260103_235200.webp" style="zoom:50%;" />

### 60 时刻：各路由器向邻居发送 RIP 报文（包含完整路由表）

<img src="../images/computer-network/image_20260103_235600.webp" style="zoom:50%;" />

每个路由器<span style="color:#E59934">仅和相邻路由器<u>周期性</u>（周期为 30 秒）地交换并更新路由信息</span>。

<img src="../images/computer-network/image_20260104_000000.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_000100.webp" style="zoom:50%;" />

<span style="color:#8F384D; font-weight:bold">经过本轮更新，RIP 已<u>收敛</u>。</span>

### 90 时刻：各路由器向邻居发送 RIP 报文（包含完整路由表）

<img src="../images/computer-network/image_20260104_000900.webp" style="zoom:50%;" />

每个路由器<span style="color:#E59934">仅和相邻路由器<u>周期性</u>（周期为 30 秒）地交换并更新路由信息</span>。

<img src="../images/computer-network/image_20260104_001000.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_001800.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_001900.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260104_002000.webp" style="zoom:50%;" />

### 150 时刻：各路由器向邻居发送 RIP 报文（包含完整路由表）

<img src="../images/computer-network/image_20260104_003900.webp" style="zoom:50%;" />

每个路由器<span style="color:#E59934">仅和相邻路由器<u>周期性</u>（周期为 30 秒）地交换并更新路由信息</span>。

<img src="../images/computer-network/image_20260104_004300.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_004400.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_010600.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_011200.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260104_011500.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_110200.webp" style="zoom:50%;" />

每个路由器<span style="color:#E59934">仅和相邻路由器<u>周期性</u>（周期为 30 秒）地交换并更新路由信息</span>。

<img src="../images/computer-network/image_20260104_112300.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_112600.webp" style="zoom:50%;" />

每个路由器<span style="color:#E59934">仅和相邻路由器<u>周期性</u>（周期为 30 秒）地交换并更新路由信息</span>。

### 360 时刻：收到邻居的 RIP 报文后，更新自己的路由信息

<img src="../images/computer-network/image_20260104_112900.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_113300.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_114200.webp" style="zoom:50%;" />

## RIP 的工作过程示例（反映 RIP 的优点）

### 700 时刻：路由器 R2 修复

<img src="../images/computer-network/image_20260104_114800.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_115400.webp" style="zoom:50%;" />

### 700 时刻：R1、R2 更新路由表

<img src="../images/computer-network/image_20260104_115600.webp" style="zoom:50%;" />

### 720 时刻：R1、R3、R4 定时发送 RIP 报文

<img src="../images/computer-network/image_20260104_115900.webp" style="zoom:50%;" />

每个路由器<span style="color:#E59934">仅和相邻路由器<u>周期性</u>（周期为 30 秒）地交换并更新路由信息</span>。

<img src="../images/computer-network/image_20260104_120500.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_172400.png" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_173400.png" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_175100.png" style="zoom:50%;" />
...
2. 若到同一个目的网络有多条相同代价的路径，则可将通信量分配给这几条路径。
   ...
   <img src="../images/computer-network/image_20260104_183900.png" style="zoom:50%;" />
...
3. OSPF 分组具有<span style="color:#FA812F; font-weight:bold">鉴别功能</span>，从而保证仅在<span style="color:#636CCB">可信赖的路由器</span>之间交换链路状态信息。例如：
   - **防止非法路由器的恶意攻击**：恶意黑客非法侵入哈基米电信机房，将未授权路由器接入 R1 设备，通过 OSPF 协议洪泛伪造 LSA。
     ...
     <img src="../images/computer-network/image_20260104_184600.webp" style="zoom:50%;" />

     <img src="../images/computer-network/image_20260104_184800.bmp" style="zoom:50%;" />

   - **防止中间人攻击篡改 OSPF 洪泛分组**：某台路由器（如 R3）被黑客攻击（中病毒），当 R3 作为中间人转发洪泛的链路信息时，恶意地将路由信息改为错误信息。

4. OSPF 支持可变长度的子网划分和无分类编制 CIDR。

   <img src="../images/computer-network/image_20260104_185500.webp" style="zoom:50%;" />

5. 每个链路状态都带上一个 32 位的序号，<span style="color:#ED3F27">序号越大，状态就越新</span>。（相当于信息的版本号）

   <img src="../images/computer-network/image_20260104_173400.png" style="zoom:50%;" />

   <img src="../images/computer-network/image_20260104_190100.jpg" style="zoom:50%;" />

   <img src="../images/computer-network/image_20260104_190200.jpg" style="zoom:50%;" />

   <img src="../images/computer-network/image_20260104_201100.jpg" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_201400.jpg" style="zoom:50%;" />

## OSPF 基本工作原理

### 路由器构建 LSDB，使用 Dijkstra 算法计算最短路径

<img src="../images/computer-network/image_20260104_202200.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_205400.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_215900.webp" style="zoom:50%;" />

### 术语：LSDB、LSA、LSI

<img src="../images/computer-network/image_20260104_233900.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_234500.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260104_235200.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260105_001400.webp" style="zoom:50%;" />

### Type 1：Hello 分组（问候分组）

<img src="../images/computer-network/image_20260105_002000.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260105_003400.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260105_004800.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260105_005600.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260105_005700.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260105_005800.webp" style="zoom:50%;" />

通过 LSR 分组，向邻居请求缺少的 LSA（头信息）。

### Type 4：LSU 分组（链路状态更新分组）

<img src="../images/computer-network/image_20260105_005900.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260105_012700.webp" style="zoom:50%;" />

路由器通过 LSU 分组，向邻居传输具体的 LSA（可能引发全网洪泛）。

<img src="../images/computer-network/image_20260105_012900.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260105_012800.webp" style="zoom:50%;" />
...
<img src="../images/computer-network/image_20260106_145900.webp" style="zoom:50%;" />

### 路由协议的分类

<img src="../images/computer-network/image_20260103_163800.webp" style="zoom:50%;" />

<span style="color:#FA5C5C">路由协议</span>分为两大类：

1. <span style="color:#1D546D">内部网关协议</span>（Interior Gateway Protocol, <span style="color:#9E3B3B">IGP</span>）用于 AS 内部的路由选择。例如 <span style="color:#1D546D">RIP、OSPF</span>。
2. <span style="color:#5C6F2B">外部网关协议</span>（External Gateway Protocol, <span style="color:#9E3B3B">EGP</span>）用于 AS 之间的路由选择。例如 <span style="color:#5C6F2B">BGP</span>。

BGP 是一种外部网关协议，用于自治系统（AS）之间交换路由信息，实现路由选择。

- 全世界目前已接近 8 万个<u>自治系统</u>。
- 自治系统之间是平级关系，不存在包含关系。

### BGP 的基本特点

小型 AS（小企业）的路由器网络数量：几台到十几台。因此小型 AS 可以运行<span style="color:#3B9797"> RIP 协议</span>找“源 → 目的”<span style="color:#3B9797">最佳路由</span>。

中型 AS（大企业/学校）路由器数量：几十台到几百台；ISP 的大小 AS 路由器数量：几千台、上万台。中型、大型 AS 可以运行 <span style="color:#CC561E">OSPF 协议</span>用 <span style="color:#CC561E">Dijkstra</span> 算法找“源 → 目的”<span style="color:#CC561E">最佳路由</span>。

全世界的路由器数量、网络数量数以亿计。“图”的规模巨大，想找到“源 → 目的”最佳路径难度很大。（复杂度极高）

<img src="../images/computer-network/image_20260106_150200.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260106_153200.webp" style="zoom:50%;" />

- 若两国打仗，为了数据安全，哈基米国 IP 分组不能从 AS4 转发。
- 若 AS4 收费更高，就选择让 AS2 转发分组。

<img src="../images/computer-network/image_20260106_150300.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260106_153400.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260106_153300.webp" style="zoom:50%;" />

> [!tip]
>
> 每个 AS 都有全球唯一的 ASN（32 bit）。

<img src="../images/computer-network/image_20260106_154000.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260106_153500.webp" style="zoom:50%;" />

> [!tip]
>
> 普通路由器通常只工作在物理层、链路层、网络层，运行 BGP 协议的路由器还包含传输层、应用层。

### BGP 的相关概念

![](../images/computer-network/image_20260106_154100.webp)

### 哪些路由器需运行 BGP 协议

<img src="../images/computer-network/image_20260106_154200.webp" style="zoom: 67%;" />

在一个自治系统中，边界路由器一定要运行 BGP 协议，内部的一些核心路由器也要运行 BGP 协议。为简化理解，姑且认为自治系统内的所有路由器都要运行 BGP 协议，与此同时，也要运行 RIP 或 OSPF 协议。

### 概念：BGP 邻居

<img src="../images/computer-network/image_20260106_165100.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260106_165200.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260106_165300.webp" style="zoom:50%;" />

## BGP 路由信息 & 工作原理示例

**知识总览**：

<img src="../images/computer-network/image_20260106_165400.webp" style="zoom:50%;" />

### BGP 工作原理示例

<img src="../images/computer-network/image_20260106_165500.webp"  />

## BGP 路由选择

**知识总结**：

<img src="../images/computer-network/image_20260107_054700.webp" style="zoom:50%;" />

### 路由选择：① 本地偏好值

<img src="../images/computer-network/image_20260107_054900.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260107_055000.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260107_060800.png" style="zoom:50%;" />
...
> [!tip]
>
> 若 AS 管理员对各条 BGP 路由没有“本地偏好”，则采用规则 ② 进行路由选择。

<img src="../images/computer-network/image_20260107_062100.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260107_062200.webp" style="zoom:50%;" />

### 路由选择：③ 热土豆路由

<img src="../images/computer-network/image_20260107_062400.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260107_062500.webp" style="zoom:50%;" />

#### 基于 RIP

<img src="../images/computer-network/image_20260107_062600.webp" style="zoom:50%;" />

#### 基于 OSPF

<img src="../images/computer-network/image_20260107_062700.webp" style="zoom:50%;" />

### 路由选择：④ BGP 标识符

<img src="../images/computer-network/image_20260107_063400.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260107_063300.webp" style="zoom:50%;" />

## BGP 的四种报文

**知识总览**：

<img src="../images/computer-network/image_20260107_072700.webp" style="zoom:50%;" />

<img src="../images/computer-network/image_20260107_073300.webp" style="zoom:50%;" />

## IP 多播

**知识总览**：

<img src="../images/computer-network/image_20260107_073900.svg"  />

<img src="../images/computer-network/image_20260107_074200.jpg" style="zoom:50%;" />
...
<span style= "color:#FA5C5C; font-weight:bold">IP 多播</span>（Multicast），曾译为“<span style="color:#FA5C5C; font-weight:bold">IP 组播</span>”。

IP 多播技术诞生于 20 世纪 80 年代末，最初主要应用于直播、视频会议等实时通信场景；近年来，其应用场景持续拓展，在 IPTV（网络电视）的技术实现中得到了广泛采用。

<img src="../images/computer-network/image_20260107_081700.svg" style="zoom:50%;" />

<span style="color:#75B06F">IP 单播 ≈ 给个人 QQ 号发消息</span>

<span style="color:#75B06F">IP 单播地址 ≈ 个人 QQ 号</span>

<img src="../images/computer-network/image_20260107_083000.svg" style="zoom:50%;" />

<span style="color:#1C4D8D">IP 多播 ≈ 给某个 QQ 群发消息</span>

<span style="color:#1C4D8D">IP 多播地址 ≈ QQ 群号</span>

### 拓展：IPTV 实现原理示意

<img src="../images/computer-network/image_20260107_092300.jpg" style="zoom:50%;" />

假设：

- 收看 _CCTV-1_ 的电视绑定 224.0.0.1 多播组
- 收看 _CCTV-2_ 的电视绑定 224.0.0.2 多播组
- 收看*某地方卫视*的电视绑定 224.0.0.3 多播组

电视调台 = 主机退出一个多播组并加入另一个多播组（用 IGMP 协议实现）

看某个电视频道 = 接受对应的视频服务器的 IP 组播分组

## 移动 IP

**知识总览**：

<img src="../images/computer-network/image_20260107_100600.svg"  />

### 移动 IP 技术要解决什么问题？

<img src="../images/computer-network/image_20260107_101500.jpg" style="zoom:50%;" />

**问题**：移动设备的 IP 地址会动态变化，如何确保网络传输不受影响？

### 移动 IP 的概念

<img src="../images/computer-network/image_20260107_105600.svg" style="zoom:67%;" />

**引入故事背景**：

诗歌剧同学上大学时办了一张北京联通电话卡，后来诗歌剧到武汉打工也一直在用这张电话卡。

为简化理解，不妨假设所有北京联通的手机，都从属于同一个子网，武汉联通的手机属于另一个子网。

<img src="../images/computer-network/image_20260107_112300.svg" style="zoom: 67%;" />

- <span style="font-weight:bold"><span style="color:#FA5C5C">移动节点</span>/移动站</span>：具有<span style="color:#FA5C5C"><u>永久 IP 地址</u></span>的移动主机。（简而言之，就是你的手机拥有和电话卡绑定的专属 IP 地址）
- <span style="font-weight:bold"><span style="color:#36656B">归属代理</span>/本地代理</span>：通常是连接在<span style="color:#36656B"><u>归属网络</u></span>（原始连接到的网络）上的路由器，负责代收数据并通过“隧道”转发给移动站的新位置。
- <span style="color:#4988C4; font-weight:bold">外地代理</span>：通常就是连接在<span style="color:#4988C4"><u>被访网络</u></span>（移动到另一地点所接入的网络）上的路由器。
- **漫游**：一个插着北京电话卡的手机，跑到外地去了，通过“外地代理”实现上网。
- <span style="color:#D73535; font-weight:bold">永久地址</span>：和手机电话号码绑定的，全球唯一的、永久的 IP 地址。（简而言之，类似于一个人的老家地址）
- <span style="color:#FFA240; font-weight:bold">转交地址</span>：手机漫游到外地网络时，被分配的<span style="color:#FFA240"><u>临时 IP 地址</u></span>。（简而言之，类似于一个人的现住址）

### 移动 IP 通信流程：移动站在本地的通信

<img src="../images/computer-network/image_20260107_122700.svg" style="zoom: 67%;" />

移动站 A 在归属网络时，按传统的 TCP/IP 方式进行通信。

### 移动 IP 通信过程：移动站漫游到外地并登记

<img src="../images/computer-network/image_20260107_133700.svg" style="zoom: 67%;" />

- 移动站 A 漫游到被访网络时，向外地代理进行<span style="color:#E37434; font-weight:bold">登记</span>，以获得一个临时的转交地址。外地代理要向 A 的归属地<span style="color:#547792; font-weight:bold">登记</span> A 的转交地址。
- 归属代理知道移动站 A 的转交地址后，会构建一条通向转交地址的<span style="color:#8A8635; font-weight:bold">隧道</span>，将截获的发送给 A 的 IP 分组进行<span style="color:#8A8635; font-weight:bold">再封装</span>，并通过隧道发送给被访网络的外地代理。

> [!tip]
>
> 隧道（Tunnel）通常就是使用 <span style="color:#628141; font-weight:bold">IP-in-IP</span> 套娃封装。

### 移动 IP 通信过程：移动站在外地接收 IP 分组

<img src="../images/computer-network/image_20260107_134700.svg" style="zoom:67%;" />

<img src="../images/computer-network/image_20260107_134800.svg" style="zoom:67%;" />

<img src="../images/computer-network/image_20260107_135500.svg" style="zoom:67%;" />

<img src="../images/computer-network/image_20260107_135800.svg" style="zoom:67%;" />

<img src="../images/computer-network/image_20260107_140100.svg" style="zoom:67%;" />

<img src="../images/computer-network/image_20260107_140500.svg" style="zoom:67%;" />

<img src="../images/computer-network/image_20260107_140800.svg" style="zoom:67%;" />

- 归属代理知道移动站 A 的转交地址后，会构建一条通向转交地址的<span style="color:#8A8635; font-weight:bold">隧道</span>，将截获的发送给 A 的 IP 分组进行<span style="color:#8A8635; font-weight:bold">再封装</span>，并通过隧道<span style="color:#E9B63B; font-weight:bold">发送给被访网络的外地代理</span>。

- 外地代理把收到的封装的 IP 分组进行<span style="color:#8A8635; font-weight:bold">拆封</span>，恢复成原始的 IP 分组，然后<span style="color:#547792; font-weight:bold">封装成帧并发送给移动站 A</span>，这样 A 在被访网络就能收到这些发送给它的 IP 分组。

### 移动 IP 通信过程：移动站在外地发送 IP 分组

<img src="../images/computer-network/image_20260107_141400.svg" style="zoom:67%;" />

<img src="../images/computer-network/image_20260107_141700.svg" style="zoom:67%;" />

<img src="../images/computer-network/image_20260107_142100.svg" style="zoom:67%;" />

移动站 A 在被访网络对外发送 IP 分组时，仍然使用自己的<span style="color:#8C00FF; font-weight:bold">永久地址作为 IP 分组的源地址</span>，此时<span style="color:#8A8635; font-weight:bold">无需通过 A 的归属代理来转发</span>，而是<span style="color:#E9B63B; font-weight:bold">直接通过被访网络的外地代理</span>。

### 移动 IP 通信过程：移动站回到归属网络

<img src="../images/computer-network/image_20260107_143300.svg" style="zoom:67%;" />

移动站 A 回到归属网络时，A 向归属代理<span style="color:#DD7BDF; font-weight:bold">登记并注销转交地址</span>。
...
1. 移动站到外地代理的<span style="color:#FF9D00; font-weight:bold">登记协议</span>。
2. 外地代理到归属代理的<span style="color:#1055C9; font-weight:bold">登记协议</span>。
3. 归属代理数据报<span style="color:#41A67E; font-weight:bold">封装协议</span>。
4. 外地代理<span style="color:#41A67E; font-weight:bold">拆封协议</span>。

> [!tip]
>
> 1. <span style="color:#FAB12F; font-weight:bold">转交地址</span>是供移动站、归属代理及外地代理使用的。移动站与其他主机之间的通信，都使用“永久地址”。
...
<img src="../images/computer-network/image_20260107_145200.webp" style="zoom:50%;" />

### 移动 IP（MIP）技术的研究和应用情况

**说明**：

- 移动 IP 技术，诞生于 20 世纪 90 年代中期，是过时技术，在现实中少有应用。
- 结合移动 IP 技术诞生的时代背景，当时的设计人员们认为“<span style="color:#DC0000">每台移动设备都可以被分配一个全球唯一的永久 IP 地址</span>”。但后来，IP 地址迅速耗尽，“移动 IP”的这种方案显然就无法大规模应用。

**技术发展**：

- **1994 年**：MIP 草案出现，NAT 技术被提出（缓解 IP 地址耗尽）。
- **1996~1997 年**：NAT 与 MIP 被认为难以兼容（MIP 难以穿透 NAT）。
- **1998~2005 年**：NAT 迅速普及全球；MIP 迅速被边缘化（后主要用于实验性网络、科研、理论教学）。

## 网络层设备

**知识总览**：

<img src="../images/computer-network/image_20260107_161400.svg"  />

### 商业路由器样式

<img src="../images/computer-network/image_20260107_161600.webp" style="zoom:80%;" />

> [!tip]
>
> 描述路由器的这些<span style="color:#DC0000; font-weight:bold">端口</span>也会译为<span style="color:#1581BF; font-weight:bold">接口</span>。

- **型号**：Cisco ASR-920-24TZ-M，24 × 1Gbps 电口 + 4 × 10Gbps 光口。
- **价格**：6000 美元。
- **支持协议**：RIP、OSPF、BGP 等。

<img src="../images/computer-network/image_20260107_161900.webp" style="zoom:50%;" />

### 路由器的组成和功能

<img src="../images/computer-network/image_20260107_163300.webp" style="zoom: 33%;" />

### 路由器的控制层面（Control Plane）

<img src="../images/computer-network/image_20260107_170500.webp" style="zoom: 33%;" />

不同的路由协议生成的路由表条目字段略有区别。例如：

- <span style="color:#E2852E; font-weight:bold">RIP</span> 生成的条目为 `[网络前缀, 下一跳 IP, 出接口, 跳数...]`。
- <span style="color:#1581BF; font-weight:bold">OSPF</span> 生成的条目为 `[网络前缀, 下一跳 IP, 出接口, Cost, 区域...]`。
- <span style="color:#62109F; font-weight:bold">BGP</span> 生成的条目为 `[网络前缀, 下一跳 IP, 出接口, AS_PATH, 本地偏好值...]`。

<span style="color:#658C58; font-weight:bold">路由表表项至少包含 `[网络前缀, 下一跳 IP, 出接口]`。</span>

典型的路由表结构如下：

<img src="../images/computer-network/image_20260107_172500.webp" style="zoom:50%;" />

### 路由器的数据层面（Data Plane）

- 每个输入输出网络层处理模块设有“<span style="color:#DC143C">输入缓冲区</span>”，用于暂存交换结构来不及处理的 IP 分组。若缓冲区慢，但仍有新的 IP 分组到达，则新分组丢失（发送网络拥塞）。
- 每个输出端口网络层处理模块设有“<span style="color:#DC143C">输出缓冲区</span>”，用于暂存交换结构已处理（已确认输出端口），但是由于带宽显示暂时无法发送到链路上的 IP 分组。

<img src="../images/computer-network/image_20260107_173200.webp" style="zoom: 40%;" />

### 路由表 vs. 转发表

<img src="../images/computer-network/image_20260107_174600.webp" style="zoom: 20%;" />

严格来说，路由表（Routing Table）、转发表（Forwarding Table）是有区别的。

但是<span style="color:#DC143C">在探讨路由选择时，通常不严格区分路由表、转发表，可以统称为“路由表”</span>。

---

**知识回顾**：

<img src="../images/computer-network/image_20260107_174900.webp" style="zoom: 67%;" />
