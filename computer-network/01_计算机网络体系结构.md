...
- <span style="color:#973131; font-weight:bold">实体</span>：在计算机网络的分层结构中，第 n 层中的活动元素（软件 + 硬件）通常称为第 n 层实体。不同机器上的同一层称为<span style="color:#447D9B; font-style:italic; font-weight:bold">对等层</span>，同一层的实体称为<span style="color:#447D9B; font-style:italic; font-weight:bold">对等实体</span>。
