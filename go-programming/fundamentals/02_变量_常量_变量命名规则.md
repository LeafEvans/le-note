...
<img src="../../images/go-programming/image_20250902_144300.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_144900.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_145400.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_145100.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_150200.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_150500.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_150900.png" style="zoom:67%;" />
...
在 `const` 块中声明多个常量时，若某行省略了值，则其值**自动继承上一行的值**。例如：
...
<img src="../../images/go-programming/image_20250902_171700.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_172100.webp" style="zoom:67%;" />

### `const` 常量结合 `iota` 使用

`iota` 是 Go 语言内置的常量计数器，专用于 `const` 声明块中生成递增的常量值，只能在常量表达式中使用。

它在每个 `const` 块开始时自动重置为 `0`，并在每行新的常量声明后递增 1。

因此，`iota` 的值本质上是当前常量在 `const` 块中的从零开始的行索引。
...
<img src="../../images/go-programming/image_20250902_173100.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_173500.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_173800.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_174300.png" style="zoom:67%;" />
...
<img src="../../images/go-programming/image_20250902_174800.png" style="zoom:67%;" />

> [!TIP]
>
> - `iota` 的递增以**行为单位**进行。
> - 同一行声明多个常量时，若使用表达式继承机制，会按照**位置一一对应**地继承前一行的多个表达式。
> - 声明多个常量并使用<u>表达式继承</u>时，要求每一行的**常量数量必须相等**（例如：第一行声明 `A`、`B` 两个常量，第二行不能只声明 `C` 一个常量；若 `C` 单独初始化则无此限制）。
