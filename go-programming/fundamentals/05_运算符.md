...
<img src="../../images/go-programming/image_20250908_100900.png" style="zoom:80%;" />
...
<img src="../../images/go-programming/image_20250908_101500.png" style="zoom:80%;" />
...
<img src="../../images/go-programming/image_20250908_104800.png" style="zoom:80%;" />

## 逻辑运算符

| 运算符 | 描述                                                         |
| ------ | ------------------------------------------------------------ |
| `&&`   | **逻辑 AND 运算符**；若两边值均为 `true`，则为 `true`，否则为 `false` |
| `||`   | **逻辑 OR 运算符**；如果两边值有一个 `true`，则为 `true`，否则为 `false` |
...
<img src="../../images/go-programming/image_20250908_110100.png" style="zoom:80%;" />
...
<img src="../../images/go-programming/image_20250908_112200.png" style="zoom:80%;" />
...
<img src="../../images/go-programming/image_20250908_113100.png" style="zoom:80%;" />
...
<img src="../../images/go-programming/image_20250908_115600.png" style="zoom:80%;" />
...
<img src="../../images/go-programming/image_20250908_120000.png" style="zoom:80%;" />
...
<img src="../../images/go-programming/image_20250908_120500.png" style="zoom:80%;" />
...
| 运算符 | 描述                                                         |
| ------ | ------------------------------------------------------------ |
| `&`    | 按位与：两个操作数对应二进制位都为 `1` 时，结果位为 `1`，否则为 `0`。 |
| `|`    | 按位或：两个操作数对应二进制位中只要有一个为 `1`，结果位即为 `1`。 |
| `^`    | 按位异或：两个操作数对应二进制位不同则结果为 `1`，相同则为 `0`。 |
| `<<`   | 左移：将操作数的二进制位全部左移指定位数，高位丢弃，低位补 `0`；相当于乘以 2^n^（n 为移动位数）。 |
| `>>`   | 右移：将操作数的二进制位全部右移指定位数；相当于除以 2^n^（n 为移动位数，向零取整）。 |
...
<img src="../../images/go-programming/image_20250908_122200.png" style="zoom:80%;" />
