...
<img src="../../../images/database/image_20251010_115000.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_115300.webp" style="zoom:80%;" />
...
1. **建表后追加复合唯一约束**
   ...
   ```mysql
   ALTER TABLE student_course ADD UNIQUE uq_student_course (studentid, courseid);
...
2. **建表时，自增主键 + 复合唯一约束**
   ...
   CREATE TABLE IF NOT EXISTS student_course (
       ...
       CONSTRAINT fk_studentid FOREIGN KEY (studentid) REFERENCES student (id),
       CONSTRAINT fk_courseid FOREIGN KEY (courseid) REFERENCES course (id),
       -- 唯一索引：实现 studentid+courseid 组合唯一，与下方唯一约束写法效果一致
   ...
   > [!tip]
   >
   > 唯一约束是保证数据唯一的逻辑规则，数据库会**自动创建**唯一索引来实现该规则；直接创建唯一索引也能达成相同的唯一性校验效果，二者功能完全等价。
...
<img src="../../../images/database/image_20251010_124100.webp" style="zoom:80%;" />

<img src="../../../images/database/image_20251010_124200.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_141800.webp" style="zoom:80%;" />

消除无效的笛卡尔积后：

<img src="../../../images/database/image_20251010_141900.webp" style="zoom:80%;" />

```mysql
SELECT * FROM emp, dept;
```

<img src="../../../images/database/image_20251010_140500.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_142400.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_143400.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_144600.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_151300.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_151800.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_151900.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_155000.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_160300.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_160400.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_162700.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_163300.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_164900.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_165600.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_170000.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_171600.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_173400.webp" style="zoom:80%;" />
...
<img src="../../../images/database/image_20251010_193000.webp" style="zoom:80%;" />
...
1. 查询员工的姓名、年龄、职位、部门信息。
   ...
   <img src="../../../images/database/image_20251010_195500.webp" style="zoom:80%;" />
...
2. 查询年龄小于 30 岁的员工姓名、年龄、职位、部门信息。
   ...
   <img src="../../../images/database/image_20251010_195800.webp" style="zoom:80%;" />
...
3. 查询拥有员工的部门 ID、部门名称。
   ...
   <img src="../../../images/database/image_20251010_200100.webp" style="zoom:80%;" />
...
4. 查询所有年龄大于 40 岁的员工，及其归属的部门名称；如果员工没有分配部门，也需要展示出来。
   ...
   <img src="../../../images/database/image_20251010_200400.webp" style="zoom:80%;" />
...
5. 查询所有员工的工资等级。
   ...
   <img src="../../../images/database/image_20251010_204500.webp" style="zoom:80%;" />
...
6. 查询“研发部”所有员工的信息及工资等级。
   ...
   <img src="../../../images/database/image_20251010_210000.webp" style="zoom:80%;" />
...
7. 查询“研发部”员工的平均工资。
   ...
   <img src="../../../images/database/image_20251010_210700.webp" style="zoom:80%;" />
...
8. 查询工资比“夜神月”高的员工信息。
   ...
   <img src="../../../images/database/image_20251010_211100.webp" style="zoom:80%;" />
...
9. 查询比平均薪资高的员工信息。
   ...
   <img src="../../../images/database/image_20251010_211600.webp" style="zoom:80%;" />
...
10. 查询低于本部门平均工资的员工信息。
    ...
    <img src="../../../images/database/image_20251010_213100.webp" style="zoom:80%;" />
...
11. 查询所有的部门信息，并统计部门的员工人数。
    ...
    <img src="../../../images/database/image_20251010_213700.webp" style="zoom:80%;" />
...
12. 查询所有学生的选课情况，展示出学生名称、学号、课程名称。
    ...
    <img src="../../../images/database/image_20251010_214700.webp" style="zoom:80%;" />
